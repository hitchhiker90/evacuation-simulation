...
Lukasz Przybyla
A modified version of the default Mesa's GridDraw.js.
 */
...
var GridVisualization = function(width, height, gridWidth, gridHeight, context, interactionHandler) {
        ...
        fireImg.src = "local/assets/fire.png"
        var smokeImg = new Image()
        smokeImg.src = "local/assets/smoke.png"
        var exitImg = new Image()
        exitImg.src = "local/assets/exit.png"
        var disImg = new Image()
        disImg.src = "local/assets/disabled.png"
        var eldImg = new Image()
        eldImg.src = "local/assets/elderly.png"
        var image_cache = {"fire": fireImg,
                           "smoke": smokeImg,
                           "exit": exitImg,
                           "disabled": disImg,
                           "elderly": eldImg}
        ...
        this.drawLayer = function(portrayalLayer, final) {
                ...
                (interactionHandler) ? interactionHandler.updateMouseListeners(portrayalLayer, final): null;
        };
        ...
        */
        ...
        this.drawCustomImage = function (shape, x, y, scale, text, text_color_) {
                if (shape == "Fire") {
                        var img = image_cache["fire"];
                } else if (shape == "Exit") {
                        var img = image_cache["exit"];
                } else if (shape == "Smoke") {
                        var img = image_cache["smoke"];
                } else if (shape == "Disabled") {
                        var img = image_cache["disabled"];
                } else if (shape == "Elderly") {
                        var img = image_cache["elderly"];
                } else {
                        var img = new Image();
                ...
                if (["Fire", "Exit", "Smoke", "Disabled", "Elderly"].includes(shape)) {
